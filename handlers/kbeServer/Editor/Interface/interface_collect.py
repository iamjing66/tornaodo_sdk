            ...
            for info in minfo:
                if IDs != "":
                    if str(info[2]) in IDs:
                        continue
                if _cback == "":
                    _cback =str(info[2]) + "|" + str(info[3]) + "|" + str(info[4]) + "|" + str(info[5]) + "|" + str(info[6]) + "|" + str(info[7]) + "|" + str(info[8]) + "|" + str(info[9]) + "|" + str(info[10]) + "|" + str(info[11]) + "|" + str(info[12]) + "|" + str(info[13]) + "|" + str(info[14]) + "|" + str(info[15]) + "|" + str(info[16])+ "|" + str(info[17])+ "|" + str(info[18])
                else:
                    _cback = _cback + "*" +  str(info[2]) + "|" + str(info[3]) + "|" + str(info[4]) + "|" + str(info[5]) + "|" + str(info[6]) + "|" + str(info[7]) + "|" + str(info[8]) + "|" + str(info[9]) + "|" + str(info[10]) + "|" + str(info[11]) + "|" + str(info[12]) + "|" + str(info[13]) + "|" + str(info[14]) + "|" + str(info[15]) + "|" + str(info[16])+ "|" + str(info[17])+ "|" + str(info[18])
        else:
            _cback = ""
    except:
        _cback = ""
