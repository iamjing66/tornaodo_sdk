...
def GetQjtDetailList(DB, pam):
    ...
    try:
        ...
        if data:
            ...
            for info in minfo:
                if _cback == "":
                    _cback = str(info[0]) + "|" + str(info[1]) + "|" + str(info[2]) + "|" + str(info[3]) + "|" + str(info[4]) + "|" + str(info[5]) + "|" + str(info[6]) + "|" + str(info[7]) + "|" + str(info[8]) + "|" + str(info[9])
                else:
                    _cback = _cback + "*" + str(info[0]) + "|" + str(info[1]) + "|" + str(info[2]) + "|" + str(info[3]) + "|" + str(info[4]) + "|" + str(info[5]) + "|" + str(info[6]) + "|" + str(info[7]) + "|" + str(info[8]) + "|" + str(info[9])
            json_data["code"] = "1"
            json_data["msg"] = _cback
        else:
            json_data["code"] = "0"
