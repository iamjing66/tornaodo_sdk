...
def GM_ImportProject(DB,self_uid,tuid,pid,UID,pname):
    ...
    data = DB.callprocAll('GM_CreateProject', (newpid,pname,int(str(subElementObj1[0].getAttribute("sm_TheData_CreateDate"))),int(str(subElementObj1[0].getAttribute("sm_TheData_EditDate"))),int(str(subElementObj1[0].getAttribute("sm_TheData_SID"))),int(str(subElementObj1[0].getAttribute("sm_TheData_BDelete")))
                                         ,float(str(subElementObj1[0].getAttribute("sm_0_TheData_C_Pos"))),float(str(subElementObj1[0].getAttribute("sm_1_TheData_C_Pos"))),float(str(subElementObj1[0].getAttribute("sm_2_TheData_C_Pos")))
                                         ,float(str(subElementObj1[0].getAttribute("sm_0_TheData_C_Rot"))),float(str(subElementObj1[0].getAttribute("sm_1_TheData_C_Rot"))),float(str(subElementObj1[0].getAttribute("sm_2_TheData_C_Rot")))
                                         ,0,float(str(subElementObj1[0].getAttribute("sm_TheData_LightIntensity"))),str(subElementObj1[0].getAttribute("sm_TheData_LightColor")),str(subElementObj1[0].getAttribute("sm_TheData_LightAngle"))
                                         ,int(str(subElementObj1[0].getAttribute("sm_TheData_Power"))),int(str(subElementObj1[0].getAttribute("sm_TheData_Sort"))),str(subElementObj1[0].getAttribute("sm_TheData_FullViewPath")),int(str(subElementObj1[0].getAttribute("sm_TheData_Publish")))
    ...
    if data:
        ...
        for i in range(len(subElementObj2)):
            ...
            _sql = "INSERT INTO "+table_name+" (`ObjID`,`objName`,`CreateDate`,`Obj_Posx`,`Obj_Posy`,`Obj_Posz`,`Obj_Rotex`,`Obj_Rotey`,`Obj_Rotez`,`Obj_Scalex`,`Obj_Scaley`,`Obj_Scalez`,`Active`,`Commonts`,`AdsortDetection`,`AdsortBeDetection`,`ParentID`,`ResType`,`ComID`,`View_FullPath`,`View_FullAbPath`,`sizeDeltax`,`sizeDeltay`,`Content`,`Collider`,`BDelete`) VALUES(" + str(subElementObj2[i].getAttribute("sm_TheData_ObjID"))+",'"+subElementObj2[i].getAttribute("sm_TheData_objName")+"',"+str(subElementObj2[i].getAttribute("sm_TheData_CreateDate"))+","+str(subElementObj2[i].getAttribute("sm_0_TheData_Obj_Pos"))+","+str(subElementObj2[i].getAttribute("sm_1_TheData_Obj_Pos"))+"," + str(subElementObj2[i].getAttribute("sm_2_TheData_Obj_Pos"))+","+str(subElementObj2[i].getAttribute("sm_0_TheData_Obj_Rote"))+","+str(subElementObj2[i].getAttribute("sm_1_TheData_Obj_Rote"))+","+str(subElementObj2[i].getAttribute("sm_2_TheData_Obj_Rote"))+"," + str(subElementObj2[i].getAttribute("sm_0_TheData_Obj_Scale"))+","+str(subElementObj2[i].getAttribute("sm_1_TheData_Obj_Scale"))+","+str(subElementObj2[i].getAttribute("sm_2_TheData_Obj_Scale"))+","+str(subElementObj2[i].getAttribute("sm_TheData_Active"))+",'"+str(subElementObj2[i].getAttribute("sm_TheData_Commonts"))+"','"+str(subElementObj2[i].getAttribute("sm_TheData_AdsortDetection"))+"','"+str(subElementObj2[i].getAttribute("sm_TheData_AdsortBeDetection"))+"',"+str(subElementObj2[i].getAttribute("sm_TheData_ParentID"))+","+str(subElementObj2[i].getAttribute("sm_TheData_ResType"))+","+str(subElementObj2[i].getAttribute("sm_TheData_ComID"))+",'"+str(subElementObj2[i].getAttribute("sm_TheData_View_FullPath"))+"','"+str(subElementObj2[i].getAttribute("sm_TheData_View_FullAbPath"))+"',"+str(subElementObj2[i].getAttribute("sm_0_TheData_sizeDelta"))+","+str(subElementObj2[i].getAttribute("sm_1_TheData_sizeDelta"))+",'"+str(subElementObj2[i].getAttribute("sm_TheData_Content"))+"',"+str(subElementObj2[i].getAttribute("sm_TheData_Collider")) + ","+str(subElementObj2[i].getAttribute("BDelete")) + ");"
            DB.edit(_sql, None)
