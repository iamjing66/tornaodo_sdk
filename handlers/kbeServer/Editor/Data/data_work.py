...
def GetWorkSQLFromTypeNew(itype,self_uid,pam, **kwargs):
    ...
    if itype == 0:
        ...
        if not kwargs["d_class"]:
            sql = "select T1.*,T2.username,0 from tb_workmarket t1 inner join tb_userdata t2 on t1.UID = t2.UID and t1.flag = 1 and t1.boutique = %s;" % kwargs["course_level"]
        else:
...
def Data_Work_Base(uid,wid,target,DB,call_type,sh=False):
    ...
    sql = GetWorkSQLFromType(3,uid,arrPam)
    result = DB.fetchone(sql, None)
    if result:
        # GM审核
        if sh:
...
def UpdateToDB(data,uid ,wID,DB,target):
    ...
    if target == 1:
        table_name = "tb_workmarket"
    sql = "select id,boutique from "+table_name+" where UID = " + str(uid) + " and WID = " + str(wID)
    result = DB.fetchone(sql,None)
    if result:
        sql_else = "'"
        if result[1] != 1:
        ...
        if len(data) == 23:
            sql = "Update "+table_name+" set WID = " + str(data[0]) + ", Name='" + str(data[1]) + "', Platform=" + str(data[2]) + ", Stars=" + str(data[3]) + ", Pid=" + str(data[4]) + ", price=" + str(data[5]) + ", `desc`='" + str(data[6]) + "', State=" + str(data[7]) + ", NewPid=" + str(data[8]) + ", CreateDate=" + str(data[9]) + ", Vision=" + str(data[11]) + ", Sid=" + str(data[12]) + ", Version=" + str(data[13]) + ", Game=" + str(data[14]) + ", GameStage=" + str(data[15]) + ", SNUM='" + str(data[16]) + "', `identity`='" + str(data[17]) + "', SNAME='" + str(data[18]) + sql_else + ",price1=" + str(data[20]) + ",price2=" + str(data[21]) + ",Free = " + str(data[22]) + ",Plat='1'"+" where UID = " + str(uid) + " and WID =" + str(wID)
        else:
            sql = "Update "+table_name+" set WID = " + str(data[0]) + ", Name='" + str(data[1]) + "', Platform=" + str(data[2]) + ", Stars=" + str(data[3]) + ", Pid=" + str(data[4]) + ", price=" + str(data[5]) + ", `desc`='" + str(data[6]) + "', State=" + str(data[7]) + ", NewPid=" + str(data[8]) + ", CreateDate=" + str(data[9]) + ", Vision=" + str(data[11]) + ", Sid=" + str(data[12]) + ", Version=" + str(data[13]) + ", Game=" + str(data[14]) + ", GameStage=" + str(data[15]) + ", SNUM='" + str(data[16]) + "', `identity`='" + str(data[17]) + "', SNAME='" + str(data[18]) + sql_else + ",price1=" + str(data[20]) + ",price2=" + str(data[21]) + ",Free = " + str(data[22]) + ",Plat=" + str(data[23]) + " where UID = " + str(uid) + " and WID =" + str(wID)
    else:
        if len(data) == 23:
